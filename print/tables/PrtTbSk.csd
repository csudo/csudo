...
String     sprintfk   "Number %d: ", kStart+1
           reinit     again
again:     PrtTbSk    gitab, String, 1, kStart
kStart     =          kStart + 1 
 endif
  endin
...
String     sprintfk   "Number %d: ", kCount
           reinit     again
again:     PrtTbSk    gitab, String, 1, 0, kEnd
kEnd       =          kEnd - 1 
kCount     =          kCount + 1
 endif
  endin
...
String     sprintfk   "Number %d:\n", kCount
           reinit     again
again:     PrtTbSk    gisin, String, 1, 0, -1, 3, 8
kCount     =          kCount + 1
 endif
  endin
...
String     sprintfk   "Number %d: ", kCount
           reinit     again
           TbPrmRndk  gitab, 1
again:     PrtTbSk    gitab, String, 1, 0, -1, 0, 0
kCount     =          kCount + 1
 endif
  endin
